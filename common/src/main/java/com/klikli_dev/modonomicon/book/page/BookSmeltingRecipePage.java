...
public class BookSmeltingRecipePage extends BookProcessingRecipePage<SmeltingRecipe> {
    public BookSmeltingRecipePage(BookTextHolder title1, ResourceLocation recipeId1, BookTextHolder title2, ResourceLocation recipeId2, BookTextHolder text, String anchor, BookCondition condition) {
